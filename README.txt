Short explanation of files and dir(s). used by Wa ke on Lan and upgrade script.
-------------------------------------------------------------------------------
...
LICENSE.txt		- short explanation of the MIT license under wich
			  this script are released.

README.txt		- This file. 

log (DIR.)		- where the log files are saved, if not present at
			  script start it will be created for you.
